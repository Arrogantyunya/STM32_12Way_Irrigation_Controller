...
unsigned char * Modbus_Coils::Get_AI_1to8(void)
{
	...
	u_int x[8] = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
	iwdg_feed();
	x[0] = analogRead(AI1);delay(10);
	x[1] = analogRead(AI2);delay(10);
	x[2] = analogRead(AI3);delay(10);
	x[3] = analogRead(AI4);delay(10);
	x[4] = analogRead(AI5);delay(10);
	x[5] = analogRead(AI6);delay(10);
	x[6] = analogRead(AI7);delay(10);
	x[7] = analogRead(AI8);delay(10);
...
void Set_Irrigation_relay(unsigned char way, bool value)
{
	switch (way)
	{
