...
/* 电流阈值储存地址 */
#define FILM_MEM_ELE_CUR_LMT_BASE_ADDR              FILM_MEM_BASE_ADDR_ALLOC(FILM_MEM_RT_OPEN_CRC_END_ADDR)
...
/* 重置行程完成标志位 */
#define FILM_MEM_RE_OK_FLAG_BASE_ADDR               FILM_MEM_BASE_ADDR_ALLOC(FILM_MEM_ELE_CUR_LMT_CRC_END_ADDR)
...
#define FILM_MEM_ONE_BYTE_SIZE_END_ADDR             FILM_MEM_ADDR_SIG(FILM_MEM_ELE_CUR_FLAG_END_ADDR)
