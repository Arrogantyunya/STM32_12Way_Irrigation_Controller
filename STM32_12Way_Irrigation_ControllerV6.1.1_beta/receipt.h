...
public:
	...
	void TimesSet_ClearEleCurrent_Receipt(unsigned char send_times, unsigned char E00Dstatus);//E00D卷膜电流倍数设置回执
	void All_Opening_Status_Receipt(unsigned char send_times);//E00E卷膜开度状态全回执
