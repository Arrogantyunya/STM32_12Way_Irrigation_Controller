...
public:
	...
	void Forgery_Receipt(bool use_random_wait, unsigned char times, unsigned char randomId_1, unsigned char randomId_2, unsigned char DO_used1, unsigned char DO_used2);//
private:
