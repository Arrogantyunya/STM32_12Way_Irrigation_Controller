...
void Check_Store_Parameter(void)
{
	...
	{
		Debug_Serial.println("SN code check ERROR !!! Applying SN code to server... <Check_Store_Parameter>");
	...
	{
		Debug_Serial.println("Group number check ERROR !!! Applying group number to server... <Check_Store_Parameter>");
	...
	{
		Debug_Serial.println("Area number check ERROR !!! Applying area number to server... <Check_Store_Parameter>");
		Message_Receipt.Request_Device_SN_and_Channel();
		LoRa_Command_Analysis.Receive_LoRa_Cmd();
		delay(WAIT_TIME);
		iwdg_feed();
...
void Check_Store_Param_And_LoRa(void)
{
	if (gCheckStoreParamFlag)
	{
		...
		// LED_RUNNING;
		Debug_Serial.println("All parameters check SUCCESS... <Check_Store_Parameter>");
	}
}
