...
#define ProgramTimeout		((unsigned int)0x0000001F)
...
/**
  ...
  *   FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status FLASH_ErasePage(unsigned int Page_Address)
{
...
/**
  ...
  *   FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT. 
  */
FLASH_Status FLASH_ProgramHalfWord(unsigned int Address, unsigned short Data)
{
