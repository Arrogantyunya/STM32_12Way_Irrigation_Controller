...
#define BT_DEVICE_FLASH_SIZE				512	//KB
...
#define BT_DP_SAVE_BASE_ADDR				0x08048000	   //224KB temporary Flash size.	

/* Fill in the starting address of the running application */
#define BT_APP_RUN_ADDR							0x08010000 // 224KB Run Flash size.
 ...
 *
 */
#define BOOT_SOFT_VERSION_H					00
#define BOOT_SOFT_VERSION_L					12	//v1.2

/*
 *
 */
#define DEVICE_HARD_VERSION_H				03
#define DEVICE_HARD_VERSION_L				00	//v3.00

/*
 *Fill in the device ID, which is the device type, to distinguish it from other devices.
 *Note: limit to two bytes.
 */
#define BT_DEVICE_ID								0xC003
...
extern char BT_PrintDBG_Buf[PRINT_DBG_LEN];
